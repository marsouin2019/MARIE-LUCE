...
<link rel="stylesheet" href="css/form.css">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="frmEmail1" aria-describedby="emailHelp" placeholder="Entrer votre email (*)" name= "frmEmail" required >
    <small id="emailHelp" class="form-text text-muted">Ce champs est obligatoire.</small>
  </div>
  <div class="form-group">
    <label for="Mot_de_passe">Mot de passe</label>
    <input type="password" class="form-control" id="frmMDP" placeholder="Indiquer votre mot de passe (*) " name= "frmPm" required>
  </div>
  <div class="form-group">
    <label for="confirm_mot_de_passe">Confirmer votre mot de passe</label>
    <input type="password" class="form-control" id="frmMDP2" placeholder="Confirmer votre mot de passe (*)"  name= "frComfirm" required>
  </div>
